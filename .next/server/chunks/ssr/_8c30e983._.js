...
function CustomerDetailPage({ params }) {
    ...
    const handleDelete = async ()=>{
        try {
            // استخدام apiClient الذي يحتوي على التوكن تلقائياً
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].delete(`/customers/${params.id}`);
            const data = response.data;
            if (!data.success) {
                throw new Error(data.error || t('submissionFailed'));
            }
...
//# sourceMappingURL=_8c30e983._.js.map