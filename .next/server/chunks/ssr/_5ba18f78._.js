...
function useCustomers() {
    ...
    const fetchCustomers = async ()=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get('/customers');
...
function CustomersPage() {
    ...
    const handleDelete = async (id)=>{
        try {
            // استخدام apiClient الذي يحتوي على التوكن تلقائياً
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].delete(`/customers/${id}`);
            const data = response.data;
            if (!data.success) {
...
//# sourceMappingURL=_5ba18f78._.js.map